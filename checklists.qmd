...
Esta rúbrica es la forma más sencilla de evaluar la enseñanza de alguien. Separa lo positivo de lo negativo y el contenido (lo que se dice) de la interacción (cómo el instructor interactúa con los alumnos y gestiona el aula) y la presentación (cómo habla). No siempre está claro en qué categoría va cada cosa, pero ayuda a organizar y comparar los comentarios.
