# Ejemplos de Mapas Conceptuales {#sec-conceptmaps}
...
En los capítulos @sec-memory y @sec-models hablamos de modelos mentales y mapas conceptuales. En este anexo compartimos varios ejemplos.

## Diferentes mapas para el mismo concepto {#sec-conceptmaps-diffmaps}
...
## Mapas conceptuales sobre Ciencia de Datos {#sec-conceptmaps-datascience}
...
![Tipos de Datos. Autores: Meghan Sposato, Brendan Cullen, Monica Alonso](diagrams/data-types.svg){fig-alt="" fig-align="center"}

![Expresiones regulares. Autores: Monica Alonso, Greg Wilson.](diagrams/regular-expressions.svg){fig-alt="" fig-align="center"}

## Mapas conceptuales sobre {#sec-conceptmaps-others}
