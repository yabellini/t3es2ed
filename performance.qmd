...
![Sentimientos sobre la retroalimentación (copyright © Deathbulge 2013)](diagrams/deathbulge-jerk.jpg){#fig-performance-feedback-feelings fig-alt = ""}
La retroalimentación es más fácil de dar y recibir cuando ambas partes comparten expectativas sobre lo que está y no está al alcance y sobre cómo se deben expresar los comentarios. Si solicitas una [retroalimentación]{i="retroalimentación!obtener"}:
