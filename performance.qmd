...
A medida que tus estudiantes van codificando, deben ver y oír lo que estás haciendo.
...
En los entornos en línea, es esencial que tus estudiantes cambien de ventana (la demostración del docente y su propia codificación) o de pantalla si tienen más de una.
...
Ya hemos mencionado que necesitas mostrar a tus estudiantes cómo acomodar su pantalla para verte mejor. Al utilizar live coding, también debes acomodar tu(s) pantalla(s) para enseñar.
...
Aquí tienes un bonito ejemplo de configuración de escritorio de Paola Corrales con una o dos pantallas.
