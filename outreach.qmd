# Difusión y vinculación {#sec-outreach}
...
## Marketing {#sec-outreach-marketing}
...
Al igual que el diseño de lecciones (@sec-process), los primeros pasos en *marketing* son crear las [personas tipo]{i="persona tipo"} de la gente que podría estar interesada en lo que estás haciendo, y averiguar cuáles de sus necesidades puedes cumplir. Una manera de resumir lo último es escribir [discursos de presentación]{g="elevator-pitch" i="discurso breve de presentación"} dirigidos a diferentes personas tipo. Una plantilla ampliamente utilizada para este objetivo es:
...
## Marcas y posicionamiento {#sec-outreach-branding}
...
## El arte de la llamada en frío {#sec-outreach-cold-call}
...
## Cambio académico {#sec-outreach-schools}
...
## Reflexiones finales {#sec-outreach-final}
...
## Ejercicios {#sec-outreach-exercises}
