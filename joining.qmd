...
<FIXME traducir estos objetivos de aprendizaje de Greg>
    ...
    Introduction
        Summarize the four key goals of this training.
        Explain how and why this training prepares people to be “educational paramedics”.
    Learner Personas
        Explain what learner personas are and what purpose they serve.
        Describe the four elements every learner persona should have.
        Create learner personas.
        Summarize lessons in ways that will appeal to specific learner personas.
    Mental Models
        Describe the distinctions between novice, competent, and expert learners in the Benner/Dreyfuss model.
        Explain what a mental model is and why it doesn’t need to be either complete or correct in order to be useful.
        Explain how the lack of a mental model impedes novices, why the goal of lessons for novices should therefore be to help them construct a mental model, and how an instructor can tell if someone has a functional mental model.
        Explain what a concept map is and what elements a concept map should have.
        Describe four ways that concept maps can be used in planning, delivering, and assessing lessons.
        Create concept maps.
        Define the term “false beginner”, explain it in terms of mental models, and explain the special challenges that false beginners present in teaching.
    Cognitive Load
        Explain the difference between long-term and short-term memory and describe the retrieval/encoding cycle.
        Describe how visual and auditory information are processed, integrated, and stored.
        Describe the cognitive processing involved in reading and summarize Benner et al’s findings about learning modes (visual + speech, visual + text, visual + speech + text).
        Define the three types of cognitive load and correctly identify examples of each.
        Explain two implications of cognitive load theory for lesson design and delivery.
        Explain what a Parsons Problem is and how its effectiveness can be grounded in cognitive load theory.
        Create Parsons Problems and explain when and how they should or shouldn’t be used.
    Cognitive Capacity
        Explain the “magic number 7±2” (capacity of short-term memory) and its implications for lesson design and delivery.
        Explain what a faded example is and how its effectiveness can be grounded in the limited capacity of short-term memory.
        Create faded examples and explain when and how they should or shouldn’t be used.
    Formative and Summative Assessment
        Define the terms “formative assessment” and “summative assessment” and explain the different roles of each.
        Explain why and how formative assessments should probe for misconceptions and describe three ways that instructors can determine what misconceptions to probe for.
        Explain the complementary purposes of formative assessments for instructors and learners.
        Explain what peer instruction is, why it is effective, and the requirements for it to be successful.
        Describe the role of summative assessment and the characteristics of effective summative assessments.
        Describe the process of reverse instructional design.
    Motivating Adult Learners
        Describe the difference between intrinsic and extrinsic motivation and explain their impact on learning and retention.
        Summarize the three main motivating factors for neurotypical adult learners.
        Summarize the three main demotivating factors for neurotypical adult learners.
        Explain why bystander (intervention) training is an effective way to ensure inclusivity and the role of scenarios and role play in acquiring these skills.
        Describe and justify the steps an instructor should take if they have to eject a learner from their class.
    Teaching Live
        Describe the key differences between static teaching materials and dynamic lesson presentation, and the role of improvisation in the latter.
        Describe the elements of a basic rubric for giving feedback on live teaching.
        Explain the four steps an instructor should take every time they make a coding mistake in front of a class.
        Critique recorded and live lesson presentations.
    Teaching Online
        Describe and summarize techniques for making interactive online teaching more effective.
        Describe two methods for ensuring that attention is fairly distributed among class participants and explain why this is important.
        Describe at least four different kinds of exercises that students can do in a programming class beyond simply writing and running code.
        Describe four ways to accommodate learners of widely-varying backgrounds in a single class and explain the pros and cons of each.
    Conclusion
        Explain the difference between active and passive learning and give two explanations for why the former is more effective.
        List six strategies learners can use to accelerate their learning and justify at least two of them in terms of the ideas introduced in this training
        Identify several common myths about education and learning.
...
Durante este taller:
* Mostraremos como contactar y preparar a tu audiencia para sumarse a una clase o
evento sincrónico (“la previa”)
* Manejaremos un evento remoto a través de Zoom que mantendrá a una audiencia
participando activamente durante tres horas.
...
Durante este taller:
  ...
  * Presentaremos la práctica de Códificación en vivo (_Live Coding_). Veremos ejemplos prácticos que ayudarán a reconocer detalles a tener en cuenta a la hora de llevarla a cabo.
...
\<FIXME cambiar por la información correcta\>
