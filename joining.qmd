...
10. Explicar qué es la demostración (y programación) en vivo.
11.Explicar los cuatro pasos que debe dar un instructor cada vez que comete un error durante una demostración en vivo delante de una clase.
12. Utilizar una rúbrica simple de evaluación.
13.Identificar buenas prácticas de programación y las formas de promover su uso entre tus estudiantes.
14. Describir recursos fuera del aula que pueden dar apoyo a tus estudiantes en su camino de aprender a programar.
...
Si quieres enseñar estos contenidos del libro utilizando el formatos de cursos cortos, [este es un un ejemplo de los materiales utilizados en el taller de tres horas en español](https://yabellini.netlify.app/courses/teach_programming/).
...
:   La extensión natural de estar en línea en grupos es estar en línea en forma individual. Al igual que con los grupos en línea, como docente hablarás la mayoría de las veces y tus estudiantes participarán principalmente a través del chat de texto o el documento compartido. También en este caso, y siempre teniendo en cuenta los aspectos de accesibilidad, un buen audio es más importante que un buen video, y quienes participan deberían usar el chat de texto para indicar que quieren hablar (@sec-meetings).
...
::: callout-warning
## TODO Yani!
Revisar el como organziar porque posiblemente puedo agregar ams material del "en una caja".
Linkear al anexo de plantillas y check list.
