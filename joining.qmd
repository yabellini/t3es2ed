...
Es posible crear cursos cortos con una duración de entre una hora y media y tres horas. Se pueden dar online de forma sincrónica o en persona. Yanina impartió estos cursos cortos más de 30 veces desde 2020. 
...
12. Reconocer fuentes de las cuales seguir aprendiendo y expandiendo prácticas pedagógicas.


::: callout-note
## Material complementario

Si quieres enseñar estos contenidos del libro utilizando alguno de los formatos de cursos cortos largos, [este es un un ejemplo de los materiales utilizados en el taller de tres horas en español](https://yabellini.netlify.app/courses/intro-abc-online/) y [este es el material utilizado en el taller de una hora y media](https://yabellini.netlify.app/courses/introalabc_corto/), también en español.
