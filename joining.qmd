...
Este material ha sido usado de muchas maneras, desde charlas de media a una hora, un seminario en línea de una hora y media, a un taller de tres horas; desde varios encuentros semanales presenciales y virtuales, hasta un taller intensivo en persona.
...
\<FIXME\> *Ver si esto lo dejamos o lo ponemos en alguno de los formatos* Por lo general, es posible cubrir gran parte de los capítulos @sec-models a @sec-process, @sec-performance, y @sec-motivation en dos días de jornada completa. \</FIXME\>

### En persona {#sec-joining-using-inperson}

\<FIXME Preguntar a Greg porqué dice esto\>Esta es la forma más efectiva de impartir esta capacitación , pero también la más exigente. \</FIXME\> Las personas que participan están físicamente en el mismo lugar. Cuando necesitan practicar cómo enseñar en pequeños grupos, parte de la clase o toda la clase va a habitaciones cercanas. Cada participante usa su propia tableta o computadora portátil para ver material en línea durante la clase y para tomar notas compartidas (@sec-classroom-notetaking), y usa lápiz y papel o pizarras para otros ejercicios. Las preguntas y la discusión se hacen en voz alta.
